...
public class MOProfileController {
    ...
    /** When set, clicking a course row jumps to Job Management with that job selected. */
    private final Consumer<Job> onOpenJobManagement;
    ...
    public MOProfileController(ServiceRegistry services, User user, Consumer<Job> onOpenJobManagement) {
        this.services = services;
        this.user = user;
        this.onOpenJobManagement = onOpenJobManagement;
        initialize();
    }
    ...
    private HBox buildCourseRow(Job job) {
        ...
        if (onOpenJobManagement != null) {
            row.setCursor(Cursor.HAND);
            row.setOnMouseClicked(e -> onOpenJobManagement.accept(job));
        }
