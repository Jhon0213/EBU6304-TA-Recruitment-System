...
public final class AppPaths {
    ...
    /** Stored CV files: {@code cv_uploads/{applicantId}/cv.pdf} or {@code cv.docx} */
    public static Path cvUploadsRoot() {
        return dataDir().resolve("cv_uploads");
    }

    public static Path cvUploadDir(String applicantId) {
        return cvUploadsRoot().resolve(applicantId);
    }
}
