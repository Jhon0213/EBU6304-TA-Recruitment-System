...
public final class I18n {
    ...
    public static void initTranslations() {
        ...
        put(en, zh, "language_change_confirm", "Are you sure you want to change the language? The system will reload and you will be logged in again.", "确定要切换语言吗？系统将重新加载并自动重新登录。");
        put(en, zh, "yes_option", "Yes", "是");
        put(en, zh, "no_option", "No", "否");
